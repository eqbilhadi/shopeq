                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Enter product purchase price" style="text-align: right" wire:model.live='form.purchasePrice' id="number-format">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Enter product selling price" style="text-align: right" wire:model.live='form.sellingPrice' id="number-format">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Enter product minimal stok" wire:model.live.debounce.200ms='form.minimalStok' id="number-only-format">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        @foreach ($inputSubUnit as $key => $subUnit)
                            ...
                            <div class="d-flex gap-2 flex-column">
                                ...
                                <div class="d-flex gap-2">
                                    <div class="w-50">
                                        <input type="text" id="number-only-format" class="form-control" wire:model='form.convertMain.{{ $key }}' placeholder="Conversion of main unit">
                                        @error("form.convertMain.{$key}")
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="w-50">
                                        <input type="text" id="number-only-format" class="form-control" wire:model='form.convertOther.{{ $key }}' placeholder="Conversion to other unit">

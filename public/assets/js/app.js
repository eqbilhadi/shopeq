      ...
      switch (e['data-layout']) {
        ...
        default:
          'vertical' == sessionStorage.getItem('data-layout') && sessionStorage.getItem('data-layout')
            ...
            ? (T('data-layout', 'horizontal'), sessionStorage.setItem('data-layout', 'horizontal'), document.documentElement.setAttribute('data-layout', 'horizontal'), k('horizontal'))
            : 'twocolumn' == sessionStorage.getItem('data-layout') && (T('data-layout', 'twocolumn'), sessionStorage.setItem('data-layout', 'twocolumn'), document.documentElement.setAttribute('data-layout', 'twocolumn'), k('twocolumn'));
      }
